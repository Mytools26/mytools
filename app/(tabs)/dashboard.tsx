      ...
      <html>
        <body style="font-family: Arial; padding: 24px;">
          ...
          <table style="width:100%; border-collapse:collapse;">
            ...
            <tr>
              <td><strong>Warehouse Items</strong></td>
              <td>${warehouseItems}</td>
            </tr>
          ...
          <table style="width:100%; border-collapse:collapse;">
            ...
            ${
              assignedRows ||
              `<tr><td colspan="6">No assigned tools</td></tr>`
            }
          </table>
          ...
          <table style="width:100%; border-collapse:collapse;">
            ...
            ${
              problemRows ||
              `<tr><td colspan="6">No broken or missing tools</td></tr>`
            }
          </table>
        </body>
      </html>
