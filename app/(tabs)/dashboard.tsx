...
export default function DashboardScreen() {
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      {/* 3 ΚΥΡΙΑ ΚΟΥΜΠΙΑ — ΠΡΩΤΑ */}
      <View style={styles.mainActions}>
        <TouchableOpacity
          style={styles.mainButtonOrange}
          onPress={() => router.push("/add-tool")}
        >
          <Text style={styles.mainButtonIcon}>🔧</Text>
          <Text style={styles.mainButtonText}>Assign Tool</Text>
        </TouchableOpacity>
        ...
        >
          ...
          <Text style={styles.mainButtonText}>Return Tool</Text>
        </TouchableOpacity>
      </View>

      <TouchableOpacity
        style={styles.mainButtonBlue}
        onPress={() => router.push("/search")}
      >
        <Text style={styles.mainButtonIcon}>🔍</Text>
        <Text style={styles.mainButtonText}>Find Tool</Text>
      </TouchableOpacity>
